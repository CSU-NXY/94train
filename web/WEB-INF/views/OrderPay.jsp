...
<div class="container" id="order">
    <table class="table table-bordered table-striped">
        <th colspan="3" style="text-align: center;background-color: #563d7c;color: #ffffff;">
           请确认您的订单信息！
        </th>
        <tr>
            <td>订&nbsp;&nbsp;单&nbsp;&nbsp;号：</td>
        ...
        <tr align="center">
            <td><a href="/user/viewBuyTickets.do" class="btn btn-warning">返回上一步</a></td>
            <td></td>
            <td><a href="/index/viewIndex.do" class="btn btn-success">我已确认订单，去支付</a></td>
        </tr>
    </table>
</div>
