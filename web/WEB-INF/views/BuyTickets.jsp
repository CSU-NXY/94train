    ...
    <div class="row">
        ...
        <div class="col-xs-8" style="margin-top: 5%;width: 80%; margin-left: 10%">
            <table class="table table-bordered table-striped text-center" align="center">
                ...
                <tr align="center">
                    <td style="width: 16%">G1234<!--直接获取列车号显示--></td>
                    <td style="width: 16%">长沙南<!--直接获取出发地显示--></td>
                    <td style="width: 16%">开往</td>
                    <td style="width: 16%">湘潭北<!--直接获取目的地显示--></td>
                    <td style="width: 16%">票价</td>
                </tr>
