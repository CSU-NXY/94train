                    ...
                    <div class="col-md-6 col-md-offset-2">
                        <form id="registerForm1" onsubmit="return PostData()">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-7"><input type="text" class="form-control" name="CheckCode" placeholder="验证码"></div>
                                <p class="form_tips">激活手机后将收到验证短信，请回填短信中的6位验证码字母、数字或者英文符号，最短8位，区分大小写</p>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-3"><h4>密码</h4></label>
                                <div class="col-xs-7"><input type="text" class="form-control" name="Password" placeholder="密码"></div>
                                <p class="form_tips">字母、数字或者英文符号，最短8位，区分大小写</p>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-3"><h4>确认密码</h4></label>
                                <div class="col-xs-7"><input type="text" class="form-control" name="password" placeholder="确认密码"></div>
                            ...
                            <input type="submit" class="btn btn-primary next right" value="注册&raquo;"/>
