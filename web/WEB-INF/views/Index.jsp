...
<div class="container" style="border: 1px solid red;width: 100%;position: relative;height: 100%;">
        <!--背景开始-->
        <div class="carousel slide" style="height: 100%;" id="myCarousel">
            <!-- 轮播（Carousel）项目 -->
        ...
        <!-- 图片下方的指示圆圈-->
        <ul class="carousel-indicators" style="z-index: 20;">
            ...
            <li id='pic5' data-target="#myCarousel" data-slide-to="4"></li>
        </ul>
        <!--背景结束-->
